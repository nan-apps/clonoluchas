...
Crafty.scene('Fight', function() {
    ...
    Crafty.e("2D, DOM, Text").attr({ x: Game.width/2-80, y: 10, z:5, w:100 }).text( 'CLONOLUCHAS' )
                                                                         .textColor( '#eeaec0', 1 )                                                                         
                                                                         .textFont({ family:'Clono', size: '30px' });
                                                                 
    Crafty.e("2D, DOM, Text").attr({ x: Game.width-145, y: Game.height-20, z:5, w:200 }).text( 'Creado por Clonosaurios' )
                                                                         .textColor( '#eeaec0', 1 )                                                                         
...
Crafty.scene('Splash', function() {
   ...
   /* Crafty.e("2D, DOM, Text,").attr({ x: x - 50, y: y+30, z:5, w:150 })
    .text( 'Primer Round' )
    .textColor( '#ffffff', 1 )                                                                         
    .textFont({ family:'Yanone', size: '30px' });*/

    var fightCommandTxt = Crafty.e("2D, DOM, Text,").attr({ x: x - 30, y: y+60, z:5, w:100 })
        .text( '"F": FIGHT' )
        .textColor( '#EBEB00', 1 )                                                                         
        .textFont({ family:'VT323', size: '15px' });
...
Crafty.scene('winPlayer1', function() {
    ...
    var winnerTxt = Crafty.e("2D, DOM, Text,").attr({ x: x - 100, y: y, z:5, w:200 })
    .css({'text-align':'center'})
    .text( 'Ganador TRUENOCERATOPS' )
    .textColor( '#ffffff', 1 )                                                                         
    .textFont({ family:'Yanone', size: '30px' });

    var resetCommandTxt = Crafty.e("2D, DOM, Text,").attr({ x: x - 30, y: y+70, z:5, w:60 })
        .css({'text-align':'center'})
        .text( '"R": RESET' )
        .textColor( '#EBEB00', 1 )                                                                         
        .textFont({ family:'VT323', size: '15px' });
